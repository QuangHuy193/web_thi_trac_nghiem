...
import { updateUserPassInfoAPI } from '../../apis';
...
function EditTeacherPage() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (response && response.message?.toLowerCase().includes('cập nhật')) {
        ...
        await Swal.fire({
          title: 'Đã cập nhật!',
          text: 'Thông tin giáo viên đã được cập nhật thành công.',
          icon: 'success',
          timer: 1500,
        ...
        Swal.fire({
          title: 'Lỗi!',
          text: response.message || 'Không thể cập nhật thông tin giáo viên. Vui lòng thử lại.',
          icon: 'error',
          confirmButtonText: 'OK',
        });
      }
      ...
      Swal.fire({
        title: 'Lỗi!',
        text: 'Không thể cập nhật thông tin giáo viên. Vui lòng thử lại.',
        icon: 'error',
        confirmButtonText: 'OK',
      });
    } finally {
  ...
  return (
    <div className={cx('container')}>
      ...
      <h1 className={cx('title')}>Chỉnh sửa thông tin giáo viên</h1>
